...
dataset_path = '/home/ramiali/Downloads/Stanford3dDataset_v1.2_Aligned_Version/merged_rooms/subsampled_13class0.010/'
file_paths = glob.glob(dataset_path + '*.txt')  # collecting all files

def norm_and_surface_variance(pc, neighbor_radius=0.5):
    """
...
for file_path in tqdm(file_paths):
    ...
    for size_ in range(len(block_size_list)):
        ...
        data_folder = dataset_path + 'Block_s' + str(block_size) + '_min_final_' + str(min_npoints) + '_norm_enhance_13class_rad_0.5/'
